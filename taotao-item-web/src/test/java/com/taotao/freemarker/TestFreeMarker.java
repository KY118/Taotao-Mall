...
public class TestFreeMarker {
	...
	public void testFreemarker() throws Exception {
		...
		//3.设置模板所在的路径
		configuration.setDirectoryForTemplateLoading(new File("D:/eclipse workspace/taotao-item-web/src/main/webapp/WEB-INF/ftl"));
		//4.设置模板的字符集，一般utf-8
...
//		Writer out = new FileWriter(new File("D:/temp/javaee28/out/student.html"));
		Writer out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("D:/temp/javaee28/out/student.html"), "UTF-8"));
